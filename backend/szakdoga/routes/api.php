...
Route::put('/diakok/edit/{userId}', [DiakController::class, 'update']);
...
Route::put('/cegek/edit/{id}', [CegController::class, 'update']);
...
Route::delete('/preferalt_cegek/torles/{diakId}/{cegId}', [PreferaltCegController::class, 'preferaltTorles']);
//C_D_Kapcsolat
